$(document).ready(function () {
    ...
    $("#submitMonth").on("click", function () {
        ...
        limitByTemps(getTopFiveRatings(callFinalRatings()));

    });

    var limitByTemps = function (callback) {
        console.log(userMonth, userHighTemp, userLowTemp);
    ...
    function indexOfMax(arr, top, category) {
        ...
        // console.log("City: " + userCities[maxIndex]);
        ...
        if (top.length === 5) {
            ...
            //**********THIS IS WHERE WE CALL THE FUNCTION THAT APPENDS THE CARDS*********************
    ...
    var getTopFiveRatings = function (callback) {
        if (arraysFilled === true) {
            ...
            console.log("arrays weren't filled")
        }
        callback;
