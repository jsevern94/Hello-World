...
function renderChart(cityIndex, i) {
        var chart = new CanvasJS.Chart(`chartContainer${i}`, {
            ...
            data: [{
                ...
                legendText: "Month",
                dataPoints: [
                    { y: parseFloat(monthlyTemps[0][cityIndex].split(":")[1]), label: "January" },
                    { y: parseFloat(monthlyTemps[1][cityIndex].split(":")[1]), label: "February" },
                    { y: parseFloat(monthlyTemps[2][cityIndex].split(":")[1]), label: "March" },
                    { y: parseFloat(monthlyTemps[3][cityIndex].split(":")[1]), label: "April" },
                    { y: parseFloat(monthlyTemps[4][cityIndex].split(":")[1]), label: "May" },
                    { y: parseFloat(monthlyTemps[5][cityIndex].split(":")[1]), label: "June" },
                    { y: parseFloat(monthlyTemps[6][cityIndex].split(":")[1]), label: "July" },
                    { y: parseFloat(monthlyTemps[7][cityIndex].split(":")[1]), label: "August" },
                    { y: parseFloat(monthlyTemps[8][cityIndex].split(":")[1]), label: "September" },
                    { y: parseFloat(monthlyTemps[9][cityIndex].split(":")[1]), label: "October" },
                    { y: parseFloat(monthlyTemps[10][cityIndex].split(":")[1]), label: "November" },
                    { y: parseFloat(monthlyTemps[11][cityIndex].split(":")[1]), label: "December" }
                ]
            }]
        });
        chart.render();
